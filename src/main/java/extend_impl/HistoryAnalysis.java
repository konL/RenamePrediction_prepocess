...
public class HistoryAnalysis {
    public static void main(String[] args) throws Exception {
        //single-process
//        ProjectCommit("camel","1");
        //batch-process
       String[] projs={"camel","flink"};
       for(String proj:projs){
           ProjectCommit(proj,"1");
     ...
     */
    public static void ProjectCommit(String projectname,String group) throws Exception {


        String projectpath = "C:/project/MethodPrediction_All_ID/data/GitProject/" + projectname + "/";
        String FileIndex = "C:/project/MethodPrediction_All_ID/data/JavaFileIndex/" + projectname + ".txt";
        //以下是程序的输出文件
        String LogOutput = "C:/project/MethodPrediction_All_ID/Renaming/log/log_output_"+projectname+".txt";
        String TraceHistory = "C:/project/MethodPrediction_All_ID/Renaming/" + projectname + ".csv";
//        String projectpath = "C:\\project\\Projects_50\\Java\\" + projectname + "\\";
//        String FileIndex = "C:\\project\\Projects_50\\JavaFileIndex\\" + projectname + ".txt";
//        //以下是程序的输出文件
//        String LogOutput = "C:\\project\\Projects_50\\log\\log"+"_"+group+".txt";
//        String TraceHistory = "C:\\project\\Projects_50\\Renaming\\" + projectname + ".csv";
        ...
        while ((line = br.readLine()) != null) {
            ...
            for (idenDS iden : alliden) {
                ...
                System.out.println("【information】:\n"+iden.getType()+","+identifier+",parent="+iden.getClasspar()+","+iden.getMethodpar());
                ...
                if(traceResult.size()>1)
                {
                    ...
                    for(String onehis:traceResult)
                    {
                        ...
                        bw.write(onehis+",");
                        System.out.println("statement="+onehis);
                    }
